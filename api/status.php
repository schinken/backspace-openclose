...
$hosts = array( 
    'all'               => (int) get_hosts_alive($con, $hostQueries['all']),
    'members'           => (int) get_hosts_alive($con, $hostQueries['members']),
    'member_devices'    => (int) get_hosts_alive($con, $hostQueries['member_devices']),
